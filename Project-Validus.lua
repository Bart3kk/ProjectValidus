...
if IsMobile then
    Library = loadstring(game:HttpGet(repo .. 'TestMobileSupport.lua'))()
else
    Library = loadstring(game:HttpGet(repo .. 'Library.lua'))()

local Library = loadstring(game:HttpGet(repo .. 'Library.lua'))()
local ThemeManager = loadstring(game:HttpGet(repoOther .. 'addons/ThemeManager.lua'))()
local SaveManager = loadstring(game:HttpGet(repoOther .. 'addons/SaveManager.lua'))()
